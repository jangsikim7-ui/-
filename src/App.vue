...
/* 다크모드 탭 텍스트 밝게 */
[data-theme="dark"] .hg-tab.active { color: #90c8ff; }
[data-theme="dark"] .hg-bora.active { color: #cc88ff; }
...
/* ═══════════════════════════════════════
   컬럼 카드 - 라이트모드
═══════════════════════════════════════ */
[data-theme="light"] .hcol {
  background: linear-gradient(160deg, #ffffff 0%, #f2f4f8 100%);
}
[data-theme="light"] .hcol-avg {
  border-color: rgba(190, 140, 0, 0.4);
  box-shadow: 0 2px 16px rgba(190, 140, 0, 0.10), 0 1px 4px rgba(0,0,0,0.06);
}
[data-theme="light"] .hcol-master {
  border-color: rgba(200, 90, 0, 0.4);
  box-shadow: 0 2px 16px rgba(200, 90, 0, 0.10), 0 1px 4px rgba(0,0,0,0.06);
}
[data-theme="light"] .hcol-indiv {
  border-color: rgba(20, 160, 70, 0.4);
  box-shadow: 0 2px 16px rgba(20, 160, 70, 0.10), 0 1px 4px rgba(0,0,0,0.06);
}
...
.hcol-avg .hcol-head { background: rgba(255, 200, 40, 0.08); border-bottom-color: rgba(255, 200, 40, 0.2); }
.hcol-master .hcol-head { background: rgba(255, 140, 20, 0.08); border-bottom-color: rgba(255, 140, 20, 0.2); }
.hcol-indiv .hcol-head { background: rgba(60, 210, 110, 0.08); border-bottom-color: rgba(60, 210, 110, 0.2); }

[data-theme="light"] .hcol-head { border-bottom-color: rgba(0,0,0,0.08); }
[data-theme="light"] .hcol-avg .hcol-head { background: rgba(255, 200, 40, 0.07); border-bottom-color: rgba(190, 140, 0, 0.2); }
[data-theme="light"] .hcol-master .hcol-head { background: rgba(255, 140, 20, 0.07); border-bottom-color: rgba(200, 90, 0, 0.2); }
[data-theme="light"] .hcol-indiv .hcol-head { background: rgba(60, 210, 110, 0.07); border-bottom-color: rgba(20, 160, 70, 0.2); }
...
.hcol-icon-avg { background: rgba(255,200,40,0.12); color: #ffd028; border-color: rgba(255,200,40,0.4); box-shadow: 0 0 12px rgba(255,200,40,0.35); }
.hcol-icon-master { background: rgba(255,140,20,0.12); color: #ff9820; border-color: rgba(255,140,20,0.4); box-shadow: 0 0 12px rgba(255,140,20,0.35); }
.hcol-icon-indiv { background: rgba(60,210,110,0.12); color: #3cd278; border-color: rgba(60,210,110,0.4); box-shadow: 0 0 12px rgba(60,210,110,0.35); }

[data-theme="light"] .hcol-icon-avg { box-shadow: 0 0 8px rgba(190,140,0,0.2); }
[data-theme="light"] .hcol-icon-master { box-shadow: 0 0 8px rgba(200,90,0,0.2); }
[data-theme="light"] .hcol-icon-indiv { box-shadow: 0 0 8px rgba(20,160,70,0.2); }

.hcol-head-text { display: flex; flex-direction: column; gap: 3px; }

/* 제목 */
.hcol-title { font-size: 15px; font-weight: 900; letter-spacing: -0.3px; }
.hcol-title-avg { color: #ffffff; text-shadow: 0 0 8px rgba(255,208,40,0.7), 0 0 20px rgba(255,180,0,0.4); }
.hcol-title-master { color: #ffffff; text-shadow: 0 0 8px rgba(255,152,32,0.7), 0 0 20px rgba(255,120,0,0.4); }
.hcol-title-indiv { color: #ffffff; text-shadow: 0 0 8px rgba(60,210,110,0.7), 0 0 20px rgba(40,190,90,0.4); }

[data-theme="light"] .hcol-title-avg { color: #7a5500; text-shadow: none; }
[data-theme="light"] .hcol-title-master { color: #7a3500; text-shadow: none; }
[data-theme="light"] .hcol-title-indiv { color: #0c6030; text-shadow: none; }
...
[data-theme="light"] .hcol-sub-avg { color: #9a7000; text-shadow: none; }
[data-theme="light"] .hcol-sub-master { color: #9a4800; text-shadow: none; }
[data-theme="light"] .hcol-sub-indiv { color: #0a7838; text-shadow: none; }
...
.podium {
  ...
  gap: 8px; padding: 24px 12px 0;
}
.pod { display: flex; flex-direction: column; align-items: center; gap: 4px; flex: 1; min-width: 0; }
.pod-0 { order: 2; }
...
.pod-av { overflow: hidden; display: flex; align-items: center; justify-content: center; border: 3px solid; }
.pod-av-circle { border-radius: 50%; }
.pod-av:not(.pod-av-circle) { border-radius: 12px; }

.pod-av-1 { width: 64px; height: 64px; border-color: #ffd028; box-shadow: 0 0 0 2px rgba(255,208,40,0.2), 0 0 12px rgba(255,208,40,0.8), 0 0 28px rgba(255,180,0,0.45), 0 0 50px rgba(255,160,0,0.2); }
.pod-av-2 { width: 52px; height: 52px; border-color: #b8c8d8; box-shadow: 0 0 0 2px rgba(184,200,216,0.2), 0 0 10px rgba(184,200,216,0.7), 0 0 22px rgba(160,185,210,0.4); }
.pod-av-3 { width: 44px; height: 44px; border-color: #d07830; box-shadow: 0 0 0 2px rgba(208,120,48,0.2), 0 0 10px rgba(208,120,48,0.65), 0 0 22px rgba(180,90,20,0.35); }

/* 라이트모드 포디움 glow 약하게 */
[data-theme="light"] .pod-av-1 { box-shadow: 0 0 0 2px rgba(255,208,40,0.3), 0 0 10px rgba(255,208,40,0.4); }
[data-theme="light"] .pod-av-2 { box-shadow: 0 0 0 2px rgba(140,160,180,0.3), 0 0 8px rgba(140,160,180,0.3); }
[data-theme="light"] .pod-av-3 { box-shadow: 0 0 0 2px rgba(208,120,48,0.3), 0 0 8px rgba(208,120,48,0.3); }

.pod-img { width: 100%; height: 100%; object-fit: cover; display: block; }
/* 로고 - 흰 배경으로 다크/라이트 둘 다 보이게 */
.pod-img-sq { object-fit: contain; background: #ffffff; padding: 4px; }
.pod-initial { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-weight: 900; font-size: 20px; }

.pod-name { font-size: 11px; font-weight: 800; text-align: center; max-width: 84px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
/* 다크 */
[data-theme="dark"] .pod-name { color: #e8e8f0; }
/* 라이트 */
[data-theme="light"] .pod-name { color: #1a1a2e; }

.pod-crew-chip { font-size: 9px; padding: 2px 7px; border-radius: 8px; font-weight: 800; border: 1px solid; white-space: nowrap; max-width: 80px; overflow: hidden; text-overflow: ellipsis; }
...
[data-theme="light"] .score-1 { color: #a07000; text-shadow: none; }
[data-theme="light"] .score-2 { color: #506070; text-shadow: none; }
[data-theme="light"] .score-3 { color: #904010; text-shadow: none; }

/* 시상대 */
.pod-stage { width: 100%; border-radius: 3px 3px 0 0; position: relative; display: flex; align-items: flex-start; justify-content: center; }
.stage-1 { height: 40px; background: linear-gradient(180deg, rgba(255,208,40,0.18) 0%, rgba(255,180,0,0.04) 100%); border-top: 2px solid #ffd028; box-shadow: 0 -5px 20px rgba(255,208,40,0.22); }
.stage-2 { height: 28px; background: linear-gradient(180deg, rgba(184,200,216,0.14) 0%, rgba(160,180,210,0.03) 100%); border-top: 2px solid #b8c8d8; }
.stage-3 { height: 20px; background: linear-gradient(180deg, rgba(208,120,48,0.14) 0%, rgba(180,90,20,0.03) 100%); border-top: 2px solid #d07830; }

[data-theme="light"] .stage-1 { background: linear-gradient(180deg, rgba(255,208,40,0.12) 0%, transparent 100%); box-shadow: 0 -4px 12px rgba(255,208,40,0.15); }
[data-theme="light"] .stage-2 { background: linear-gradient(180deg, rgba(140,160,180,0.10) 0%, transparent 100%); border-top-color: #9aaabb; }
[data-theme="light"] .stage-3 { background: linear-gradient(180deg, rgba(208,120,48,0.10) 0%, transparent 100%); }

.stage-label { position: absolute; top: 7px; left: 50%; transform: translateX(-50%); font-size: 9px; font-weight: 900; letter-spacing: 0.8px; white-space: nowrap; }
...
[data-theme="light"] .stage-1 .stage-label { color: #a07000; text-shadow: none; }
[data-theme="light"] .stage-2 .stage-label { color: #607888; text-shadow: none; }
[data-theme="light"] .stage-3 .stage-label { color: #904010; text-shadow: none; }

/* ═══════════════════════════════════════
   4위~ 리스트
═══════════════════════════════════════ */
.rank-divider { height: 1px; background: rgba(255,255,255,0.06); margin: 0 12px; }
[data-theme="light"] .rank-divider { background: rgba(0,0,0,0.08); }

.rank-list { padding: 8px 10px 14px; display: flex; flex-direction: column; gap: 2px; }
.rank-row { position: relative; border-radius: 8px; overflow: hidden; transition: background 0.15s; cursor: default; }
.rank-row:hover { background: rgba(255,255,255,0.03); }
[data-theme="light"] .rank-row:hover { background: rgba(0,0,0,0.04); }
...
[data-theme="light"] .rank-bar-bg { opacity: 0.15; }

.rank-content { position: relative; z-index: 2; display: flex; align-items: center; gap: 7px; padding: 6px 10px; }

.rank-num { font-size: 10px; font-weight: 800; width: 14px; text-align: center; flex-shrink: 0; }
[data-theme="dark"] .rank-num { color: #777; }
[data-theme="light"] .rank-num { color: #aaa; }

.rank-thumb { flex-shrink: 0; width: 26px; height: 26px; }
/* 크루 로고 - 흰 배경으로 다크/라이트 둘 다 보이게 */
.rank-logo { width: 26px; height: 26px; border-radius: 6px; object-fit: contain; display: block; background: #ffffff; padding: 2px; }
.rank-profile { width: 26px; height: 26px; border-radius: 50%; object-fit: cover; border: 1.5px solid; display: block; }
.rank-initial-sm { width: 26px; height: 26px; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 800; }

.rank-name { flex: 1; font-size: 11px; font-weight: 700; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
[data-theme="dark"] .rank-name { color: #c8c8d8; }
[data-theme="light"] .rank-name { color: #1a1a2e; }

.rank-crew-chip-sm { font-size: 9px; padding: 1px 6px; border-radius: 5px; font-weight: 800; border: 1px solid; flex-shrink: 0; white-space: nowrap; }

.rank-val { font-size: 10px; font-weight: 800; flex-shrink: 0; letter-spacing: -0.3px; font-variant-numeric: tabular-nums; }
[data-theme="dark"] .rank-val { color: #888; }
[data-theme="light"] .rank-val { color: #333; }
